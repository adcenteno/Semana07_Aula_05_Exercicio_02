...
function getPropertyValuesComparison(arrayFormInstance){
	if(confirm("Deseja ver algumas comparações no console?")){
...
function getFormInstance(){
	...
	getPropertyValuesComparison(arrayFormInstance)
	return arrayFormInstance
}


let arrayFormInstance = getFormInstance();